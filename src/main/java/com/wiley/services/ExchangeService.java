...
public class ExchangeService {
	   ...
	   //@Autowired
	   FeeLadder feeLadder;
	   public List<NseDTO> loadNseOrders()
	   {
		   return nseExchangeRepository.findAllNseOrders();
	   }
	   public List<BseDTO> loadBseOrders()
	   {
		   return bseExchangeRepository.findAllBseOrders();
	   }
