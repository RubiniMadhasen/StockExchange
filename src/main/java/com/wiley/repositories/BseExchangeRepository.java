...
//		public int addOrderIntoBse(@Param("cName")String companyName,@Param("noShares")int noOfShares,@Param("sharePrice")int sharePrice);
	...
	@Query("SELECT new com.wiley.dto.BseDTO(o.orderId,o.companyName,o.noOfShares,o.orderType,o.sharePrice) FROM BseOrderTable o ")
	public List<BseDTO> findAllBseOrders();
