...
//	public int addOrderIntoNse(@Param("cName")String companyName,@Param("noShares")int noOfShares,@Param("sharePrice")int sharePrice);
	...
	@Query("SELECT new com.wiley.dto.NseDTO(o.orderId,o.companyName,o.noOfShares,o.orderType,o.sharePrice) FROM NseOrderTable o ")
	public List<NseDTO> findAllNseOrders();
